...
TEST(orb_extractor, extract_with_rectangle_mask_1) {
    ...
    // mask (上下20%をマスク)
    params.mask_rects_ = {{0.0f, 1.0f, 0.0f, 0.2f}, {0.0f, 1.0f, 0.8f, 1.0f}};
    auto extractor = feature::orb_extractor(params);
...
TEST(orb_extractor, extract_with_rectangle_mask_2) {
    auto params = feature::orb_params();
    // mask (上下20%をマスク)
    params.mask_rects_ = {{0.0f, 0.2f, 0.0f, 1.0f}, {0.8f, 1.0f, 0.0f, 1.0f}};
    auto extractor = feature::orb_extractor(params);
...
TEST(orb_extractor, extract_with_rectangle_mask_3) {
    auto params = feature::orb_params();
    // mask (上下左右20%をマスク)
    params.mask_rects_ = {{0.0f, 0.2f, 0.0f, 1.0f}, {0.8f, 1.0f, 0.0f, 1.0f}, {0.0f, 1.0f, 0.0f, 0.2f}, {0.0f, 1.0f, 0.8f, 1.0f}};
    auto extractor = feature::orb_extractor(params);
